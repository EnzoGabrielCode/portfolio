...
Abra o seu MySQL (Workbench ou Terminal) e crie o banco de dados:

CREATE DATABASE portfolio_db;


No código do projeto, abra o arquivo src/database/db.js.

Edite a linha de conexão com a sua senha do MySQL:
